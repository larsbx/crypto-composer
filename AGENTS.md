...
- When replacing a crucial design element (constraints, contracts, or graph semantics), perform a double-check: add a focused regression test and a short rationale note (docs/assumptions) before finalizing.
